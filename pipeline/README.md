...
[![Version](https://img.shields.io/badge/version-2.2.0-orange.svg)](https://github.com/TestVDB/releases)
...
```bash
/plugin marketplace add TestVDB
...
```bash
git clone https://github.com/TestVDB.git
cd TestVDB
claude --plugin-dir .
```
